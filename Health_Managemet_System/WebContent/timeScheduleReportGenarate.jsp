...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    	...
    	String dayCat = request.getParameter("dayCategory");
...
<body>
		...
		<div class="container btn-area" style="background: #f2f2f2; margin-top: 20px; margin-bottom: 20px; padding: 20px;">
			...
			<button type="button" class="btn btn-primary" onclick="getReportByTimeSchedule()" style="margin-left: 20px" > <span><i class="fas fa-print"></i> </span>  Generate Report</button>
					

		</div>

			<!-- time schedule -->
		  	<div class="container mt-3 mb-3" id="printscheduleDetailsArea">
		  		...
		  		<div class="container row" style="margin-bottom: 30px">
		  			...
		  			<div class="col-8">
		  		  		<%
				  			if(dayCat== null){
				  				%>
				  				<h2 style="margin-top: 100px; font-weight: bold;"> All Doctors Schedule</h2>
				  				<%
				  			}else{
				  				%>
							  		<h2 style="margin-top: 100px; font-weight: bold;"><%= dayCat+" "%>Doctors Report</h2>
				  				<%
				  			}
		  				%>
		  			</div>
		  		...
		  		<!-- //logo area -->
					...
					<table class="table" id="timeTable">
						...
						<thead class="primary-background text-white " style="font-weight: bold;">
						  ...
						  <tbody>					    
						   	<%					   	
						   		List<timeManagement> tm = timeManagementDButill.getDetailsByDayType(dayCat);
