...
<body>
					...
					<div class="row mt-3">
						...
						<div class="col-md-3" >
							...
							<div class="list-group">
							  ...
							  <a href="#" onclick="getDocDetails(0,this)" class="clickThisLink list-group-item list-group-item-action active">
							    All Specialist
							  </a>
							  ...
							  <%
							  	...
							  	for(docCategory c:docCat){
							  		%>
							  		
								 	 <a href="#" onclick="getDocDetails(<%= c.getDcid() %>, this)" class="clickThisLink list-group-item list-group-item-action"><%= c.getName() %></a>
	...
	<script>
		...
		function getDocDetails(cid, activeThisSelectedLink) {
