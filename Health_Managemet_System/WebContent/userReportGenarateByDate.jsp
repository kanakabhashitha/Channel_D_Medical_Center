...
<body>
			...
			<div class="container btn-area" style="background: #f2f2f2; margin-top: 20px; margin-bottom: 20px; padding: 20px;">
					...
					<button type="button" class="btn btn-primary" onclick="generateUserPDF()" style="margin-left: 20px" > <span><i class="fas fa-print"></i> </span>  Generate Report</button>
					

			</div>
				
			<!-- user list user -->
		  	<div class="container mt-3 mb-3" id="printUserDetals">
		  		...
		  		<div class="container row" style="margin-bottom: 30px">
				  	...
				  	<h2 style="margin-top: 100px; font-weight: bold;">User Report [ From <%= regStartDate %> To <%= regEndDate %> ]</h2>
					...
					<thead class="primary-background text-white " id="tableShow" style="font-weight: bold; display:">
						<tr>
						  ...
						  <tbody>					    
						     ...
						     <%						     
						     	List<patient> pd = patientDButill.getDetailsBydate(regStartDate, regEndDate);
						     	...
						     	for(patient p:pd){
						     		...
						     		%>
						     			<tr style="font-weight: bold;">
											      ...
											      <td><%= p.getPid() %></td>
											      <td><img class="img-thumbnail" src="proPics/<%= p.getImage() %>" alt="Card image cap" id="imgProfile" style="width: 80px; height: 80px"></td>
											      <td><%= p.getName() %></td>
											      <td><%= p.getAge() %></td>
											      <td><%= p.getAddress() %></td>
											      <td><%= p.getGender() %></td>
						     	...
						     	if(pd.size()==0){
									...
									%>
										...
										<div class="container text-center" >
											...
											<h2>No Found Data From <%= regStartDate %> To <%= regEndDate %></h2>
